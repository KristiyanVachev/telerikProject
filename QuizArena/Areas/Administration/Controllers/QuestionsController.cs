...
namespace QuizArena.Areas.Administration.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,QuestionText,AnswerRight,AnswerWrong1,AnswerWrong2,AnswerWrong3")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,QuestionText,AnswerRight,AnswerWrong1,AnswerWrong2,AnswerWrong3")] Question question)
        {
            if (ModelState.IsValid)
            {
